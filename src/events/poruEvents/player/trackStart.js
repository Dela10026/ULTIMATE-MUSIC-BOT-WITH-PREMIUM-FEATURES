...
module.exports.run = async (client, player, track) => {
    ...
    const titles = track.info.title.length > 200 ? track.info.title.substr(0, 200) + "..." : track.info.title;
    const authors = track.info.author.length > 200 ? track.info.author.substr(0, 200) + "..." : track.info.author;
    ...
    const Started = new EmbedBuilder()
        .setAuthor({
            name: `Now Playing`,
            iconURL: "https://cdn.discordapp.com/emojis/1213064036606943254.gif?size=128&quality=lossless",
        })
